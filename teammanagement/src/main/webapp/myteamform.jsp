		...
		<div class="row">
			...
			<div class="col-sm-5 bootcards-cards" id="listDetails">
				<div id="contactCard">
						...
						<div class="panel-heading clearfix">
							<h3 class="panel-title pull-left"><b>Ficha jugador</b></h3>
							  <c:if test="${teamForm.propietarioEquipo || teamForm.adminCompeticion}">
							      <button type="button" class="btn btn-success pull-right" id="botonFicharJugador" onClick="">
					...
					<!--list of notes-->
					<c:if test="${teamForm.propietarioEquipo}">
						<div>
							...
							<div class="panel panel-default">
								...
								<div class="list-group" id="plantillaActual">
								</div>		
							</div>
    ...
    function loadPlayerData(idJugador){
    	...
    	$.ajax({
    		...
    		success: function(response){
    			...
    			$("#botonFicharJugador").attr("onClick", 'signPlayer('+response.idJugador+')');
