 ...
 * Generated at: 2018-01-23 17:32:59 UTC
...
public final class finanzasform_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<h3 class=\"panel-title pull-left\"><b>Ingresos y gastos</b></h3>\n");
      out.write("\t\t\t\t</div>\t\t\t\t  \n");
      out.write("\t\t\t    <div class=\"list-group\">\n");
      out.write("\t\t\t      <div class=\"list-group-item\" id=\"listaAsientos\">\n");
      out.write("\t\t\t      </div>\n");
      out.write("\t\t\t    </div>\n");
      out.write("\t\t\t    <div class=\"list-group\">\n");
      out.write("\t\t\t      <div class=\"list-group-item\" id=\"balance\">\t\t\t      \t\n");
      out.write("\t\t\t      </div>\n");
      out.write("\t\t\t    </div>\t\t\t    \n");
      out.write("   \t\t\t\t  <div class=\"panel-footer\">\n");
      out.write("   \t\t\t\t  \t  \t\n");
      out.write("\t\t\t          <select class=\"form-control\" name=\"seasonSelect\" id=\"seasonSelect\">\t          \n");
      out.write("\t\t\t\t\t\t");
      ...
      out.write("     });\n");
      out.write("    \n");
      out.write("    $( \"#seasonSelect\" ).change(function() {\n");
      out.write("    \tloadPartidos(($('select[name=seasonSelect]').val()));\n");
      out.write("    \t});\n");
      out.write("    \n");
      ...
      out.write("    \t$.ajax({\n");
      out.write("    \t\ttype:\"get\",\n");
      out.write("    \t\turl: \"/finanzas/findAsientosEquipoTemporada\",\t\n");
      out.write("    \t\tdata: ({ idEquipo: idEquipo, idTemporada: idTemporada}),\n");
      out.write("    \t\tdataType: \"json\",\n");
      out.write("    \t\tsuccess: function(response){\n");
      out.write("    \t\t\t$( \"#listaAsientos\" ).empty();\n");
      out.write("    \t\t\t\n");
      out.write("    \t\t\tfor (var i in response.listaAsientos){\n");
      out.write("    \t\t\n");
      out.write("    \t\t\t\tvar icono = '<i class=\"fa fa-3x fa-plus pull-left\" style=\"color:green\"></i>';\n");
      out.write("    \t\t\t\t\n");
      out.write("    \t\t\t\tif (response.listaAsientos[i].importe<0){\n");
      out.write("    \t\t\t\t\ticono = '<i class=\"fa fa-3x fa-minus pull-left\" style=\"color:red\"></i>';\n");
      out.write("    \t\t\t\t}\n");
      out.write("    \t\t\t\tvar date = new Date(response.listaAsientos[i].fecha);\n");
      out.write("    \t\t\t\tvar dateFormatted = date.getDate() + '/'+(date.getMonth() + 1) + '/' +  +  date.getFullYear();\n");
      out.write("    \t\t\t\t\n");
      out.write("    \t\t\t\t$( \"#listaAsientos\" ).append('<div class=\"list-group-item\"><div class=\"row\"><div class=\"col-sm-6\">'+\n");
      out.write("\t\t\t            icono +\n");
      out.write("\t\t\t            '<h4 class=\"list-group-item-heading\">'+response.listaAsientos[i].concepto+'</h4>'+\n");
      out.write("\t\t\t            '<p class=\"list-group-item-text\"></p>'+\n");
      out.write("\t\t\t          '</div>'+\n");
      out.write("\t\t\t          '<div class=\"col-sm-6\">'+\n");
      out.write("\t\t\t            '<p class=\"list-group-item-text\">'+dateFormatted+'</p>'+\n");
      out.write("\t\t\t            '<p class=\"list-group-item-text\">$'+$.number( response.listaAsientos[i].importe , 0 )+'</p>'+\n");
      out.write("\t\t\t          '</div></div></div></div>');\n");
      out.write("    \t\t\t}\n");
      out.write("    \t\t\t$( \"#balance\" ).text('Balance temporada: $'+ $.number( response.balanceTemporada , 0 ));\n");
      out.write("\n");
      out.write("    \t\t\t\n");
      out.write("    \t\t\t   \t\t\t\n");
      out.write("    \t\t},\n");
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /finanzasform.jsp(27,0) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f0.setValue("/");
      // /finanzasform.jsp(27,0) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /finanzasform.jsp(66,6) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/finanzasform.jsp(66,6) '${finanzasForm.listaTemporadas}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${finanzasForm.listaTemporadas}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /finanzasform.jsp(66,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("temporada");
      // /finanzasform.jsp(66,6) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${temporada.idTemporada}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write('"');
            out.write('>');
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${temporada.nombreTemporada}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</option>\t\t\t\t    \n");
            out.write("\t\t\t\t\t\t");
