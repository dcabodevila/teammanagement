    ...
    try {
      ...
      if (_jspx_eval_c_005fif_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t      </div>\t\t\t\t      \t\t\t\t      \n");
          out.write("\t\t      \t\t\t  <div class=\"list-group-item\">\n");
          out.write("\t\t  \t\t\t\t    <p class=\"list-group-item-text\">Objetivo</p>\n");
          out.write("\t\t\t\t\t\t\t<h4 class=\"list-group-item-heading\">");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${competitionForm.nombreArquetipo}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</h4>\n");
          out.write("\t\t\t\t\t      </div>\t\t\t\t\t      \t\t\t\t      \t\t\t\t      \n");
          out.write("\t\t\t\t        </div>\n");
          out.write("\t\t\t        ");
